...
#ifndef NRFCXX_NRF52840_CORE_HPP
#define NRFCXX_NRF52840_CORE_HPP
#pragma once
...
struct GPIO_Instance<1> {
  static constexpr const GPIO_Type& peripheral{P1};
  static constexpr int begin_psel = GPIO_Instance<0>::end_psel;
  static constexpr int end_psel = begin_psel + P1.AUX;
};

} // ns nrf5
} // ns nrfcxx

#endif /* NRFCXX_NRF52840_HPP */
