...
/** Board-specific header for Waveshare BLE400
 *
 * Assignments correspond to labeled headers on the BLE400, with I2C
 * supplied by TWI0 and SPI by SPI1 to avoid conflict.  "NSS" (30) is
 * on the SPI header and is assumed to be the default chip-select
 * line.  "SMBA" (2, SCOPE0) is on the I2C header, and is intended for
 * SMBus notification that a device needs to be serviced.
 *
